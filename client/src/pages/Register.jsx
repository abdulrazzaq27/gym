      ...
      <div className="flex-1 flex items-center justify-center px-4 relative z-10">
        <div className={`w-full max-w-sm transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-xl p-4 shadow-2xl border border-slate-700/50 relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 via-blue-500/20 to-purple-500/20 rounded-xl blur-xl opacity-50"></div>
            ...
            <div className="relative z-10">
              ...
              <div className="text-center mb-4">
                ...
                <p className="text-slate-400 text-xs">Create your gym management account</p>
              </div>
              ...
              <div className="space-y-3">
                {/* Name Field */}
                <div className="group">
                  <label className="block text-slate-300 font-medium mb-1 text-sm">Full Name</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <User className="w-4 h-4 text-slate-400 group-focus-within:text-cyan-400 transition-colors duration-300" />
                    </div>
                    <input
                      type="text"
                      placeholder="Enter your full name"
                ...
                <div className="group">
                  <label className="block text-slate-300 font-medium mb-1 text-sm">Confirm Password</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <CheckCircle className="w-4 h-4 text-slate-400 group-focus-within:text-cyan-400 transition-colors duration-300" />
                    </div>
                    <input
          ...
          <div className="absolute -bottom-10 -right-10 w-24 h-24 bg-emerald-400/10 rounded-full blur-xl animate-pulse delay-1000"></div>
        </div>
      </div>
    </div>
  );
