  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 overflow-hidden">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <div className="absolute top-1/4 -left-40 w-80 h-80 bg-blue-200/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 -right-40 w-96 h-96 bg-green-200/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-purple-200/10 rounded-full blur-3xl animate-pulse delay-2000"></div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="text-2xl font-bold">
            <span className="relative inline-block">
              ...
              <span className="relative text-cyan-500">FitZone</span>
            </span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
              <h1 className="text-5xl lg:text-7xl font-extrabold leading-tight mb-6">
                MANAGE YOUR{' '}
                <span className="text-cyan-600 font-extrabold">GYM SMARTER </span>
                WITH FITZONE
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                ...
                <button className="px-8 py-4 border border-gray-300 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 text-gray-900">
                  BOOK A DEMO
                </button>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className={`group p-8 bg-gradient-to-br from-gray-50/50 to-white/50 rounded-2xl border border-gray-200/50 backdrop-blur-sm hover:from-gray-100/50 hover:to-gray-50/50 transition-all duration-500 transform hover:scale-105 hover:shadow-2xl ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-gray-100/80 to-white/80 rounded-2xl p-8 backdrop-blur-sm border border-gray-200/50 shadow-2xl">
                {/* Dashboard Header */}
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-lg p-4">
                    <div className="text-2xl font-bold text-cyan-600">$12.5K</div>
                ...
                {/* Chart Mockup */}
                <div className="h-32 bg-gradient-to-r from-gray-200/50 to-gray-100/50 rounded-lg flex items-end justify-around p-4">
            ...
            <div>
              ...
              <h3 className="text-2xl lg:text-3xl font-bold mb-6 text-cyan-500">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-gradient-to-br from-gray-50/50 to-white/50 rounded-2xl p-8 backdrop-blur-sm border border-gray-200/50 hover:from-gray-100/50 hover:to-gray-50/50 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl"
              >
      ...
      <section className="py-20 px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-500">Choose the perfect plan for your gym</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              <div
                key={index}
                className={`relative bg-gradient-to-br from-gray-50/50 to-white/50 rounded-2xl p-8 backdrop-blur-sm border transition-all duration-300 transform hover:scale-105 hover:shadow-2xl ${plan.popular
                    ? 'border-cyan-300 shadow-cyan-300/25 ring-1 ring-cyan-300/50'
              ...
              >
                ...
                <button className={`w-full py-4 rounded-lg font-bold text-lg transition-all duration-300 transform hover:scale-105 ${plan.popular
      ...
      <section className="py-20 px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl lg:text-6xl font-extrabold mb-6">
            TAKE YOUR{' '}
            <span className="text-cyan-600 font-extrabold">GYM</span>
      ...
      {/* Footer */}
      <footer className="py-8 px-6 border-t border-gray-200 text-center text-gray-500 relative z-10">
